    ...
    <div className="flex min-h-screen flex-col bg-slate-50">
      ...
      <main className="mx-auto flex w-full max-w-6xl flex-1 gap-4 px-4 py-4">
        <section className="flex w-[38%] flex-col gap-4">
          <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
            ...
            <p className="mb-3 text-xs text-slate-500">
              Upload an Excel workbook. MTM-8 will detect regions, measures and
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
            ...
            <ul className="space-y-1 text-xs text-slate-600">
              ...
              <li>
                • Output includes semantic context, report plan and formula
                plan.
              </li>
              <li>
                • Use "Refine" to nudge the engine without losing intent.
              </li>
            </ul>
          </div>
        </section>
        ...
        <section className="flex w-[62%] flex-col gap-4">
          <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
            ...
            <p className="mb-3 text-xs text-slate-500">
              Describe the table, pivot, chart or KPI you want. MTM-8 uses the
              uploaded workbook as context.
            </p>
              ...
              <div className="flex items-center justify-between gap-3">
                ...
                <div className="flex flex-1 items-center justify-end gap-3 text-[11px] text-slate-500">
                  ...
                  <span className="hidden sm:inline">
                    Query length:{" "}
                    <strong>{effectiveQuery.length}</strong> chars
                  </span>
                </div>
              </div>
            </div>
      ...
      <footer className="border-t border-slate-200 bg-white/70">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-2.5">
          <p className="text-[11px] text-slate-500">
            ExcelWizPro MTM-8 · semantic reporting engine for Excel. This UI is
            a thin shell over the backend.
          </p>
